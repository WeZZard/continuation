    ...
    var body: some View {
        List(selection: $selection) {
            Section("Fleet") {
                ...
                // Supervised sessions live behind one tab, not as loose
                // rows: the sidebar names places to go, and the sessions
                // themselves belong in the list, grouped by project.
                Label("Review", systemImage: "person.crop.square.filled.and.at.rectangle")
                    .badge(store.waitingCount)
